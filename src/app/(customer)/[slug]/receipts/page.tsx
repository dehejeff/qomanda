  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: '#0b1326', color: '#dae2fd' }}>
      ...
      <main className="px-6 pt-6 space-y-5 relative z-10">
        ...
        >
          <div>
            <p className="text-[10px] font-mono uppercase tracking-widest mb-1" style={{ color: '#a78b7d' }}>
        ...
        {payments.length === 0 ? (
          ...
          <>
            ...
            />
            <p className="text-xs text-center leading-relaxed px-4 pb-2" style={{ color: '#584237' }}>
