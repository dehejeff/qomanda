...
export const metadata: Metadata = {
  title: 'Termos de Uso — Qomanda',
  description: 'Termos de uso da plataforma Qomanda para restaurantes e clientes.',
}
...
export default function TermosPage() {
  return (
    <LegalPageShell
      title="Termos de Uso"
      subtitle="Estes termos regem o acesso e a utilização da plataforma Qomanda por restaurantes parceiros, colaboradores e clientes finais."
      updatedAt="31 de maio de 2026"
    >
      <LegalSection title="1. Quem somos">
        <p>
          A <strong>Qomanda</strong> é uma plataforma digital que permite a restaurantes oferecerem cardápio,
      ...
      <LegalSection title="2. Aceitação">
        <p>
          Ao acessar ou utilizar a Qomanda — seja como restaurante, colaborador autorizado ou cliente — você
      ...
      <LegalSection title="4. Uso permitido">
        <p>Você concorda em utilizar a Qomanda apenas para fins lícitos, relacionados à operação ou consumo
      ...
      <LegalSection title="7. Propriedade intelectual">
        <p>
          A marca Qomanda, software, layout, textos institucionais e demais elementos da plataforma são
        ...
        <p>
          ...
          titularidade, concedendo à Qomanda licença limitada para exibição e operação do serviço.
        </p>
      </LegalSection>
      ...
      <LegalSection title="9. Limitação de responsabilidade">
        <p>
          Na extensão permitida pela lei, a Qomanda não se responsabiliza por danos indiretos, lucros
      ...
      <LegalSection title="11. Lei aplicável e foro">
        <p>
          ...
          Qomanda e restaurante, o foro da comarca de São Paulo/SP, salvo disposição legal em contrário.
        </p>
      </LegalSection>
