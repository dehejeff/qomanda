  ...
  return (
    <div className="w-full flex flex-col items-center space-y-2">
      <div className="flex items-center gap-4 w-full">
        ...
        <span className="text-[11px] font-mono uppercase tracking-widest text-center" style={{ color: '#a78b7d' }}>Teste</span>
        <div className="h-px flex-1" style={{ background: '#584237' }} />
      </div>
      <a href={href}
      ...
      <p className="text-[10px] font-mono text-center leading-relaxed" style={{ color: '#584237' }}>
